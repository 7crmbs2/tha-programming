...
//Zeichnet ein Rechteck mit Leerzeichen in der angegebenen Hintergrundfarbe
void console_zeichne_rechteck(int xpos, int ypos, int x_size, int y_size, char* farbe)
{
